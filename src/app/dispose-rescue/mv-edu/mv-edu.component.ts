...
@Component({
  selector: 'app-mv-edu',
  templateUrl: './mv-edu.component.html',
  styleUrls: ['./mv-edu.component.css']
})
export class MvEduComponent implements OnInit {
  ...
  model_title: any;
  private  urls = Urls;
  GetVillageManager_Edu(city= null):  any {
    const params = {
      'city': city
    };
    const data = this.http.get(this.urls.GetVillageManager_Edu, {params: params})
      .toPromise()
  ...
  click(params): void {
    this.dtOptions = {
      ...
      ajax: url_main + '/v_manager/get_data_by_edu/' + this.current_city + '/' +  params.name,
      columns: [
        {title:'序号',data:'Id'},
        {title:'姓名',data:'Name'},
