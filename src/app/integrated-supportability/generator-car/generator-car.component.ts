...
@Component({
  selector: 'app-generator-car',
  templateUrl: './generator-car.component.html',
  styleUrls: ['./generator-car.component.css']
})
export class GeneratorCarComponent implements OnInit {
  private last=null;
  private option = {
    grid: {
      left: '3%',
