...
export class IsIndexComponent implements OnInit {
  private detail:any="综合保障系统简介           综合后勤保障(ILS)是美军在20 世纪60 年 代提出来的解决保障问题的一种新的管理思想和 工作方法。这种方法的指导思想是在装备研制过 程中,同步开展有关装备保障的管理和技术活动, 在装备设计之初,确定最佳的保障性要求,进行保 障性设计,同步考虑主装备保障问题。在主装备 交付部队使用时,获得装备保障所需的各种保障 资源,并在使用阶段以最低的费用提供装备所需 的保障。\n" +
