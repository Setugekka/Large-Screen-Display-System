...
@Component({
  selector: 'app-p-manager-bar',
  templateUrl: './p-manager-bar.component.html',
  styleUrls: ['./p-manager-bar.component.css']
})
export class PManagerBarComponent implements OnInit {
